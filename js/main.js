...
function init(){
  ...
  map.controls.remove('geolocationControl'); // удалениегеолокации
  map.controls.remove('searchControl'); // удаление поиск
  map.controls.remove('trafficControl'); // удаление контроль трафика
  map.controls.remove('typeSelector'); // удаление тип
  ...
  map.behaviors.disable(['scrollZoom']); // отключение скролл карты (опционально)
